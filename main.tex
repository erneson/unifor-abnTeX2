...
%%% DADOS PARA A CAPA %%%
%%%%%%%%%%%%%%%%%%%%%%%%%
\curso{Programa de Pós-Graduação em Informática Aplicada} % Curso de Ciência da Computação
% \centro{Centro de Ciências Tecnológicas}                % Descomente para monografias
...
% \quartomembro{Nome do quarto membro}                   % Descomente se o coorientador não estiver na banca
% \instituicaoquartomembro{Instituição do quarto membro} % Descomente se o coorientador não estiver na banca
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% DADOS PARA A FOLHA DE APROVAÇÃO %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
